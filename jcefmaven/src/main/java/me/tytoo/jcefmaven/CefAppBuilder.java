...
import me.tytoo.jcefmaven.impl.progress.ConsoleProgressHandler;
import me.tytoo.jcefmaven.impl.step.check.CefInstallationChecker;
import me.tytoo.jcefmaven.impl.step.extract.TarGzExtractor;
import me.tytoo.jcefmaven.impl.step.fetch.PackageClasspathStreamer;
import me.tytoo.jcefmaven.impl.step.fetch.PackageDownloader;
import me.tytoo.jcefmaven.impl.step.init.CefInitializer;
import me.tytoo.jcefmaven.impl.util.FileUtils;
import me.tytoo.jcefmaven.impl.util.macos.UnquarantineUtil;
 ...
 * your needs. When done, call {@link me.tytoo.jcefmaven.CefAppBuilder#build()}
...
public class CefAppBuilder {
    ...
    public CefAppBuilder() {
        ...
        mirrors.add("https://github.com/trethore/jcefmaven/releases/download/{mvn_version}/jcef-natives-{platform}-{tag}.jar");
        mirrors.add("https://maven.pkg.github.com/trethore/jcefmaven/me/tytoo/jcef-natives-{platform}/{tag}/jcef-natives-{platform}-{tag}.jar");
    }
